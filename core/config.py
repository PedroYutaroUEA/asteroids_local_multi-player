...
TETHER_MAX_DIST = 280.0
TETHER_SCORE_COST_PER_SEC = 20.0
...
# Time bomb settings
TIME_BOMB_COOLDOWN = 10.0
TIME_BOMB_TTL = 10.0
TIME_BOMB_RADIUS = 8
TIME_BOMB_SPEED = 200.00
TIME_BOMB_TIME_TO_EXPLODE = 1.5
...
RICOCHET_BULLET_RADIUS = 4  # Padding maior
RICOCHET_DURATION = 15.0  # Duração do powerup ao coletar
